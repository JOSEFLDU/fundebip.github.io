...
function openModal(url, type) {
    ...
    if (type === 'image') {
        modalBody.innerHTML = `
            <div class="modal-image-fullview">
                <div class="image-loader" style="display: flex;">
                ...
                <img src="${url}" 
                     ...
                     onerror="this.onerror=null; this.src='https://via.placeholder.com/800x600?text=Imagen+no+disponible'; this.style.display='block'; this.previousElementSibling.style.display='none';">
            </div>
        `;
    } else if (type === 'video') {
        // Mantén el código de video existente
        modalBody.innerHTML = `
